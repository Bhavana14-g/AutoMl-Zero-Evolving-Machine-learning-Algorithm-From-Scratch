...
namespace automl_zero
{
    ...
    bool Instruction::isSameOpButHasDifferentParam(const Instruction &other) const
    {
        return op_ == other.op_ &&
               !this->paramEquals(other) &&
               children_ == other.children_;
    ...
    bool Instruction::paramEquals(const Instruction &other) const
    {
        return in1_ == other.in1_ &&
               in2_ == other.in2_ &&
               out_ == other.out_ &&
