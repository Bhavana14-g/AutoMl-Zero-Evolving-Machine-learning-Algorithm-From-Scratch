...
bazel run -c opt \
  ...
  --search_experiment_spec=" \
    ...
    predict_ops: [VECTOR_MEAN_OP, SCALAR_CONST_SET_OP, VECTOR_INNER_PRODUCT_OP, SCALAR_DIFF_OP, SCALAR_PRODUCT_OP, SCALAR_VECTOR_PRODUCT_OP, VECTOR_SUM_OP] \
